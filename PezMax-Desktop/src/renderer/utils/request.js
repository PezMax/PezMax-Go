...
import { showSessionExpired } from '@/components/SessionExpiredModal'
import { PTMJ_AUTH_ROUTES, isPtmjAuthRoute } from '@/constants/ptmjAuth'
...
service.interceptors.request.use(config => {
  ...
  if (!isRepeatSubmit && !isFormDataPayload(config.data) && (config.method === 'post' || config.method === 'put')) {
    const requestObj = {
      url: config.url,
